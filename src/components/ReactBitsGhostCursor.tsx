/*
ReactBits Ghost Cursor
Source: https://www.reactbits.dev/animations/ghost-cursor
Notes:
- This is the original three.js + postprocessing implementation.
- We wrap it in a full-screen fixed parent in Home.tsx.
*/
...
import "./ReactBitsGhostCursor.css";

export type ReactBitsGhostCursorProps = {
  className?: string;
...
const ReactBitsGhostCursor = ({
  ...
  return (
    <div
      ref={containerRef}
      className={`reactbits-ghost-cursor ${className ?? ""}`}
      style={mergedStyle}
      aria-hidden="true"
    />
  );
...
export default ReactBitsGhostCursor;
